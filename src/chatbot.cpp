...
////
    ...
    // copy constructor
        ChatBot::ChatBot(const ChatBot& src) : _image{nullptr}, _currentNode{nullptr}, _rootNode{nullptr}, _chatLogic{nullptr} {
    ...
    // move constructor
        ChatBot::ChatBot(ChatBot&& src) : _image{src._image}, _currentNode{src._currentNode}, _rootNode{src._rootNode}, _chatLogic{src._chatLogic} {
